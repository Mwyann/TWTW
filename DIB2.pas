...
//--------------------------------------------------------------------------------------------------
//--------------------------------------------------------------------------------------------------
//                        -   NOUVEAUX EFFETS SPECIAUX   -  (Fran�ais)                            //
//--------------------------------------------------------------------------------------------------
//   Au commencement, mon id�e �tait de d�river un composant de TCustomDXDraw. Malheureusement,   //
...
// Alors, j'ai utilis� l'unit� DIB pour mon travail,mais celle-ci est pauvre en effet sp�ciaux.   //
// Connaissant une librairie avec beaucoup plus d'effets sp�ciaux, j'ai entrepris d'importer      //
// cette librairie dans l'unit� DIB. Vous pouvez voir la librairie FastLib � :                    //
//                                                                                                //
//      ->      Gordon Alex Cowie <gfody@jps.net> www.jps.net/gfody                               //
//                                                                                                //
//   C'�tait tr�s difficile car l'impl�mentation graphique est tr�s diff�rente de l'unit� DIB.    //
// Parfois, j'ai abandonn� les possibilit�s de l'effet original, particuli�rement dans la         //
// conversion des DIB avec 256, 16 et 2 couleurs. Si quelqu'un arrive � impl�menter ces           //
// fonctionnalit�s, merci de me dire comment ce miracle est possible !!!                          //
// Toutes ces proc�dures ont �t� traduites et adapt�es par:                                       //
//                                                                                                //
//      ->      Mickey (Michel HIBON) <mhibon@ifrance.com> http://mickey.tsx.org                  //
//                                                                                                //
// IMPORTANT : Ces proc�dures ne modifient pas la structure de l'unit� DIB                        //
// Nota Bene : Je n'ai pas impl�ment� ces types de graphiques (32 et 16 bit par pixels),          //
